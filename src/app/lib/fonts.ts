import {
    Arimo, Barlow, DM_Sans, Dosis, Fira_Sans, Heebo,
    IBM_Plex_Sans, Inconsolata, Inter, Josefin_Sans, Kanit, Karla,
    Lato, Libre_Baskerville, Libre_Franklin, Lora, Manrope, Merriweather,
    Mukta, Mulish, Nanum_Gothic, Noto_Sans, Noto_Serif, Nunito,
    Oswald, Poppins, PT_Sans, PT_Sans_Narrow, PT_Serif, Quicksand,
    Raleway, Roboto, Rubik, Titillium_Web, Ubuntu, Work_Sans
...
export const fontsDictionary = {
    ...
    Libre_Baskerville: { name: 'Libre Baskerville', family: 'Libre_Baskerville', instance: libre_Baskerville },
...
export const fontsArray = Object.keys(fontsDictionary).map(key => fontsDictionary[key as keyof typeof fontsDictionary]);
